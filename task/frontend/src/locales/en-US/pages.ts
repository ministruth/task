export default {
  ...
  'pages.script.content': 'Manage task scripts',
  'pages.script.add.title': 'Add script',
  'pages.script.view.title': 'View script',
  'pages.script.delete.title': 'Delete script {name}, confirm?',
  'pages.script.op.run': 'Run',
};
